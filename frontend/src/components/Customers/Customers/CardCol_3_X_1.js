...
const CardCol3X1 = () => {
  return (
    <div className="w-full flex justify-between items-center my-6 flex-wrap md:flex-nowrap">
      ...
      <div className="w-1/2 sm:w-/2 h-[124px] mb-2 mx-12 md:mx-0 md:mr-3 px-2 bg-white rounded-xl drop-shadow-md">
        <div className="h-full flex flex-col justify-between">
          ...
          <div>
            <div className="flex justify-between items-center px-[10px]">
              <p className="text-peppermartDark30 text-[14px]">All Customers</p>
      ...
      <div className="w-1/2 sm:w-1/2 h-[124px] mb-2 mx-12 md:mx-0 md:mr-3 px-2 bg-white rounded-xl drop-shadow-md">
        <div className="h-full flex flex-col justify-between">
          <div className="flex justify-between items-center py-[12px] px-[10px]">
            <HiOutlineShoppingBag className="text-[20px]" />
            <div className="flex justify-between items-center">
          ...
          <div>
            <div className="flex justify-between items-center px-[10px]">
              <p className="text-peppermartDark30 text-[14px]">New Customers</p>
