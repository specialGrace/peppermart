            ...
            <div className="basis-full md:basis-3/4" style={bg}>
                <div className="flex flex-col items-center justify-center" >
                    ...
                    <div className="bg-white shadow rounded  w-full  md:w-1/2 p-6 md:p-16  md:ml-10">
                        ...
                        <p className="text-sm mt-4 mb-6 font-medium leading-none text-gray-500">
                        ...
                        <div>
                            ...
                            <input placeholder="Input your email here" aria-label="enter email adress" role="input" type="email" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        </div>
                        <div className="mt-6  w-full">
                            <lable className="text-sm font-medium leading-none text-gray-800">Password</lable>
                            <div className="relative flex items-center justify-center">
                                <input placeholder="Type your password here" aria-label="enter Password" role="input" type="password" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        ...
                        <div className="flex justify-between mt-3">
                            <div>
                                <input type='checkbox' />  <span className="text-sm mt-4 font-medium leading-none text-gray-500">
                                    Remember me</span>
                            </div>
                        ...
                        <div className="mt-8">
                            <button role="button" aria-label="create my account" className="focus:ring-2 focus:ring-offset-2 focus:peppermartDark500 text-sm font-semibold leading-none text-white focus:outline-none bg-peppermartDark500  border rounded hover:bg-peppermartDark500 py-4 w-full ">
                                Login
                            </button>
                        </div>
