        ...
        <>
            <div className=" md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                ...
                <div className="h-screen xl:px-20 bg-white shadow-lg  xl:w-1/2 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                    ...
                    <p tabIndex={0} className="focus:outline-none text-base my-4 font-medium leading-none text-gray-500">
                        Already have an account?{" "}
                        <a href="/vendor/vendor/login" className="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-md font-medium leading-none text-gray-800 cursor-pointer">
                            {" "}
                            Log in
                        </a>
                    </p>
                    ...
                    <div>
                        ...
                        <input id="email" aria-labelledby="email" type="email" className="bg-white border rounded text-md font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="Input Your email here " />
                    </div>
                    <div className="mt-6 w-full">
                        ...
                        <div className="relative flex items-center justify-center">
                            <input id="myInput" type={showpass ? "text" : "password"} placeholder="Type your password here" className="bg-white border rounded text-md font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                    ...
                    <div className="mt-8">
                        <Link href="/vendor/vendor/newstore">
                            <button role="button" className="bg-peppermartDark500 focus:ring-2 focus:ring-offset-2 focus:peppermartDark500 text-xl font-semibold leading-none text-white focus:outline-none border rounded hover:bg-peppermartDark500 py-4 w-full">
                                Register
                            </button>
                        </Link>
                    </div>
