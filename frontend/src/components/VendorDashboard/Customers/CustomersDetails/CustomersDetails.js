                ...
                <div className="w-full flex flex-col md:flex-row justify-between mx-6 md:mx-0">
                    ...
                    <div className="flex items-center">
                        <button className="flex justify-center items-center w-[160px] hover:opacity-60 mr-0 md:mr-3 py-[5px] px-[2px] bg-peppermartDark500 text-white rounded-md">
                            <span className="text-white font-Inter mr-3">
                                Edit Customer
                            </span>
                            <BsChevronDown className="text-white " />{" "}
                        </button>

                        <button className="flex justify-center items-center w-[170px]  hover:opacity-60 py-[5px] px-[2px] bg-peppermartRed200 text-white rounded-md">
                            <span className="text-white font-Inter mr-3 ">Suspend Customer</span>
                            {/* <BsChevronDown className="text-white " />{" "} */}
                        </button>
                    </div>
                </div>
