...
const Cards = ({icon1,icon2,week,title,amount,Volume,price,percentage,padding,percent,backgroundColor}) => {
  return (
    <div className="flex justify-evenly h-32 m-auto mt-4" style={{padding:padding,}}>
